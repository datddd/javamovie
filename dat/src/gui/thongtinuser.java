...
public class thongtinuser extends javax.swing.JInternalFrame {

    private user currentUser;
    private String id;
    public thongtinuser(String id) throws SQLException {
        DAOuser daoUser = new DAOuser();
        this.currentUser = daoUser.getUserByUsername(id);
        initComponents();
        displayUserInfo();
    }

    private void displayUserInfo() {
        jTextField2.setText(currentUser.getTendn());
        jTextField3.setText(currentUser.getMk());
        jTextField4.setText(currentUser.getname());
        jTextField5.setText(currentUser.getEmail());
        jTextField6.setText(currentUser.getSdt());
    }
